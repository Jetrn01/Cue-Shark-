...
:root{--pm-purple:#a020f0}.pmDisplayBrand{display:flex;align-items:center;gap:.55vw;color:#fff}.pmDisplayBrand svg{width:clamp(46px,4.2vw,82px);height:auto}.pmDisplayBrand b{font-size:clamp(24px,2.5vw,48px);font-weight:900;letter-spacing:-.04em}.pmDisplayBrand b span{color:var(--pm-purple)}.displayLoading,.displayError{min-height:100vh;background:#0b1020;color:#fff;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px}.displayLoading p,.displayError p{opacity:.7}
