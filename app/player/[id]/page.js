...
export default function PublicPlayer(){
 ...
 if(error)return <main className="playerPage"><Brand/><div className="playerCard"><h2>Unable to load player</h2><p>{error}</p></div><style>{css}</style></main>;
 if(!player)return <main className="playerPage"><Brand/><div className="playerCard">Loading player…</div><style>{css}</style></main>;
